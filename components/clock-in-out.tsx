    ...
    return (<>
        <View style={styles.clockContainer}>
            <Pressable
                ...
                ]}><Text style={styles.clockBtnText}>Clock-in</Text></Pressable>

            <Pressable onPress={() => { setHoursPage(hoursPage ? false : true) }}
                style={({ pressed }) => [
                    {
                        backgroundColor: pressed
                            ? loginBtnActive
                    ...
                    styles.clockBTN
                ]}><Text style={styles.clockBtnText}>Hours</Text></Pressable>
        </View>
        {
            hoursPage ?
                <Hours />
